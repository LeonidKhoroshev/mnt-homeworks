...
21.10.2018 в 22:52 на `GitHub.com` зафиксирован сбой базы данных (БД), что привело к некорректному отображению информации на сайте, потере части данных и отсутствию возможности создавать `GitHub Pages` и обслуживать вебхук (технология оповещения о новых событиях на сервере).
...
Некорректное отображение информации на сайте, остутствие части данных и невозможность создания `GitHub Pages` и обслуживания вебхуков.

### Обнаружение

Неисправность обнаружена инженерами первой группы реагирования спустя 10 минут после инцидента благодаря алертам внутренних систем мониторинга GitHub.

### Реакция

Спустя 5 минут, после обнаружения ницидента, инженеры вручную заблокировали внутренние средства развёртывания, чтобы предотвратить внесение дополнительных изменений. После появления дополнительной информации о характере и масштабах технологического нарушения командой GitHub разработан план по восстановлению пользовательских данных. Исходя из повышенных требований к конфиденциальности и сохранности информации на полное восстановление инфраструктуры сайта ушло более суток.

#### Восстановление 

Пользовательские данные восстановлены из резервных копий БД Восточного побережья, а также путем реплицикации данных, записанных в БД Западного побережья. В процесс восстановления оперативно вносились коррективы исходя из изменения времени восстановления данных (в течении суток скорость репликации менялась исходя из пользовательской активности и нагрузки на функционирующие узлы). 
...
- изменена конфигурация Orchestrator в части запрета перемещения первичных БД за границы региона;
- ускорена миграция на новую систему отчётности по статусам с более чёткими и ясными формулировками;
- организована поддержка обслуживания трафика GitHub из нескольких ЦОД по архитектуре active/active/active (цель — поддержка избыточности N+1 на уровне ЦОД, чтобы выдерживать отказ одного ЦОД без вмешательства со стороны).
#### Организационные мероприятия:
- внедрение системной практики проверки сценариев сбоев;
- применение инструментов хаос-инжиниринга.
